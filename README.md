...
This is a Classic Firefox userstyle based on amazing [CustomCSSforFx](https://github.com/Aris-t2/CustomCSSforFx) project + couple small tweaks. 
...
`userChrome.css` - this is the main file for css styles. It imports (links) other css files.
...
I have two tweaks there. Change Segoi UI font to Arial. I just hate Segoi UI) But you can change it to anything you have on your pc.

Second tweak is for devtools. It removes breadcrumbs which always get in a way for me.
